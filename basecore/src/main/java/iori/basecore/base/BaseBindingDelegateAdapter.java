...
public abstract class BaseBindingDelegateAdapter<M, B extends ViewDataBinding> extends DelegateAdapter.Adapter
{
    protected Context context;
    protected ObservableArrayList<M> items;
    protected ListChangedCallback itemsChangeCallback;

    public BaseBindingDelegateAdapter(Context context)
    {
    ...
    public LayoutHelper onCreateLayoutHelper() {
        ...
        layoutHelper.setItemCount(items.size());
        return layoutHelper;
    }
